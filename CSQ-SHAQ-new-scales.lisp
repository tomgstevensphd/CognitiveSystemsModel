...
;;
;;ddd
(defun list-shaqclasses ()
  (list-file-objects "CSQ-shaq-new-scales" '(my-defclass) :dir "CogSys-Model")
  )
;; (list-shaqclasses)
...
;;MY-DEFCLASSES CAUSES ERRORS IN DELIVER IF TRY TO CREATE INSTANCES 
  ...
  (my-defclass BIO (assessment per-system)
               ...
               (:default-initargs
                :title "BIO"
                 :name-string "BIO"
                  :label  "c-BIO"
                ;;no slot :scale-name "Biographical Information"
                 :description "Biographical informaton"
                 :scale-group-name "BIO Class"
                   :subscales '(ACAD-ACH NO-SCALE)
                :scale-group-description "Biographical data scales-questions."
                :csartloc '$BIO
                ))
  ...
  (my-defclass VALUES-THEMES (assessment per-system)
               ...
               (:default-initargs
                :title "VALUES-THEMES"
                 :name-string "VALUES-THEMES"
                  :label  "c-VALUES-THEMES"
                    ;;no slot :scale-name "Values-Life Themes Scales"
                 :description "Values-Life Themes Scales: 11 Scales"
                 :scale-group-name "Values-Themes Class"
                   :subscales '(ST1HIGHERSELF ST2SOCINTIMNOFAM ST3FAMCARE ST4SUCCESSSTATUSMATER ST5-ORDERPERFECTIONGOODNESS ST6GODSPIRITRELIG ST7IMPACTCHALLENGEEXPLOR ST8ATTENTIONFUNEASY ST9VALUESELFALLUNCOND ST10OVERCMPROBACCEPTSELF ST11DUTYPUNCTUAL)
  ...
  (my-defclass BELIEFS  (assessment per-system)
               ...
               (:default-initargs
                :title "BELIEFS"
                 :name-string "Beliefs"
                  :label  "c-BELIEFS"
                    ;;no slot :scale-name "Beliefs Class Scales"
                 :description "Beliefs Scales"
                 :scale-group-name "Beliefs Class"
                   :subscales '(SWORLDVIEW STBSLFWO SIECONTR SETHBEL SGRFEARS)
  ...
  (my-defclass SKILLS-CONFIDENCE  (assessment per-system)
               ...
               (:default-initargs
                :title "SKILLS-CONFIDENCE"
                 :name-string "SKILLS-CONFIDENCE" 
                  :label  "Life Area Skills & Confidence "
                   ;;no slot  :scale-name "Beliefs Class Scales"
                 :description "Life Area Skills &Confidence Scales"
                 :scale-group-name "Skills-Confidence Class"
                   :subscales '(SSLFCONF SSELFMAN SEMOTCOP)
  ...
  (my-defclass INTERPERSONAL (assessment per-system)
               ...
               (:default-initargs
                :title "INTERPERSONAL ATTRIBUTES"  
                 :name-string "Interpersonal Attributes"
                  :label  "Interpersonal Attributes"
                    ;;no slot :scale-name "Interpersonal Attribute Class Scales"
                 :description "Interpersonal Values, Beliefs, Skills, Habits"
                 :scale-group-name "Interpersonal Attribute Class"  
                   :subscales '(INTSS1AASSERTCR INTSS1BOPENHON INTSS2ROMANTC INTSS3LIBROLE INTSS4LOVERES INTSS5INDEP INTSS6POSSUP INTSS7COLLAB)
  ...
  (my-defclass ACAD-LEARNING (assessment per-system)
               ...
               (:default-initargs
                :title "ACADEMIC-LEARNING"     
                 :name-string "ACADEMIC-LEARNING"
                  :label  "Academic Learning"
                  ;;no slot   :scale-name "Academic-Learning Class Scales"
                 :description "Academic and Learning Values, Beliefs, Skills, Habits."
                 :scale-group-name "Academic and Learning Attributes"  
                   :subscales '(SCOLLEGE SSL1CONFIDEFFICSTUDYTEST SSL1BCONFIDNOTAVOIDSTUDY SSL2SATISCAMPUSFACFRIENDSGRDES SSL3WRITEREADSKILLS SSL4BLDMENTALSTRUCT SSL5BASICSTUDYSKILLS SSL6SELFMANACADGOALS SSL7MATHSCIPRINC SSL8STUDYENVIR SSL9ATTENDHW SSL10MEMNOTANX SSL11NOTNONACADMOT SSL12STDYTMAVAIL SSL13VERBALAPT SSL14MATHAPT)
  ...
  (my-defclass CAREER-INTEREST (assessment per-system)
               ...
               (:default-initargs
                :title "CAREER/MAJOR INTEREST"
                 :name-string "CAREER/MAJOR INTEREST"
                  :label  "Career/Major Interests"
                   ;;no slot  :scale-name "Career/Major Interest Scales"
                 :description "Career/Major Interests: related to college majors"
                 :scale-group-name "Career/Major Interest Scales Group"  
                   :subscales '(SINCAR SINBUS SINENGR SINFINEA SINHELP SINLANG SINMED SINMILTC INNATSCI SINSOCSC SINWOETH SINWRITE)
  ...
  (my-defclass OUTCOME (assessment per-system)
               ...
               (:default-initargs
                :title "OUTCOME"
                   :name-string "OUTCOME"
                  :label  "Life Outcomes"                
                   ;;no slot  :scale-name "Life Outcomes Class Scales"
                 :description "Life Outcomes: Emotional, Relationship, Career, Academic"
                 :scale-group-name "Life Outcomes Group Scales"  
                   :subscales '(SEHAPPY SRDEPRES SRANXIET SRANGAGG SRELHLTH SRPEOPLE)
                :scale-group-description "These scales are related to important life outcomes. SHAQ researchers have used data from these scales to correlate to the HQ and other scales to see how closely-related these HQ, etc. factors are to important life outcomes—emotional outcomes, educational achievement, career achievement, relationship outcomes, health outcomes, and satisfaction in various life areas."
                :csartloc '$OUTC
                ))
  #|(my-defclass values-themes (assessment per-system)
    ()           
  ...
  (my-defclass BIO-TEXT (text-answer-question scale) ;;was BIO
               ...
               (:default-initargs
                ...
                :scale-questions '(FRAME-BIO-INFO  FRAME-FAMILY-INFO)
                 :relative-score nil  :reverse-scored-p NIL   :num-questions 0
                ))
 ...
 ;;  ((ID UTYPE UGOALS BIO3EDUC BIO4JOB BI07LANG BIO1ETHN BIORELAF)  ;;("Biographical Information:"))
  ...
  (my-defclass BIO-MAQ (multi-answer-scale)
               ...
               (:default-initargs
                ...
                :scale-questions '(BIO4JOB BIO7LANG BIO1ETHN BIORELAF SFAMILY)
                 :relative-score nil  :reverse-scored-p NIL   :num-questions 5
                ))
  ...
  (my-defclass HQ  (composite-scale)
     ...
     This scale correlated .865 with overall happiness, .730 with low depression, .675 with low anxiety, .701 with low anger/aggression, .816 with the health outcomes scale, and .693 with overall relationship success.  It also correlated .486 with income, .458 with education level, and .393 with college grade average.  By any psychological research standards, these are high correlations showing that  HQ is a powerful predictor of not only overall happiness and other emotions, but of life success in the areas of  relationships, career, and health."
                :scale-group-name   "composite-scale"
                   :subscales '(ST1HIGHERSELF ST2SOCINTIMNOFAM ST3FAMCARE ST4SUCCESSSTATUSMATER ST5-ORDERPERFECTIONGOODNESS ST6GODSPIRITRELIG ST7IMPACTCHALLENGEEXPLOR ST8ATTENTIONFUNEASY ST9VALUESELFALLUNCOND ST10OVERCMPROBACCEPTSELF ST11DUTYPUNCTUAL SWORLDVIEW STBSLFWO SIECONTR SETHBEL SGRFEARS SSLFCONF SSELFMAN SEMOTCOP INTSS1AASSERTCR INTSS1BOPENHON INTSS2ROMANTC INTSS3LIBROLE INTSS4LOVERES INTSS5INDEP INTSS6POSSUP INTSS7COLLAB)
                :scale-questions '()
                :mean-score 100  :standard-deviation 10 :sample-N nil   :relative-score nil  :reverse-scored-p NIL   :num-questions  0
                :help-priority 1
  ...
  (my-defclass HigherSelfScale (composite-scale)
     ...
     The Higher Self Values scale included making happiness important, but also included values like integrity, self-sufficiency, impacting the world, and learning and self-development. The Higher Self scale correlated .503 with overall happiness, .252 with low depression, .197 with low anxiety, .372 with low anger-aggression, .365 with health outcomes, and .436 with relationship outcomes. "
                ...
                :scale-questions '(thmimpac  thm33goa  thm6lear   
                                             thm9shap  thm10oth  thm14ind  thm22bod  thm23bal 
                                             thm34exp  thmcompc 
                                             thminteg  thmphil  thmbeaut  thmgoodn  thmplayf 
                                             thmsesuf  thmsedis 
                                             thmuncon  tbvbalan  tbvhapca  tbvgrati  thvselfa 
                                             thvuncon  thvselfw)
                :mean-score ".678"  :standard-deviation ".125" :sample-N 3217
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  24
                :help-priority 1
  ...
  (my-defclass sID  (BIO-TEXT)
               ...
               (:default-initargs
                ...
                :scale-questions '(Frame-bio-info)
                 :relative-score nil  :reverse-scored-p NIL   :num-questions 6
                 :csartloc '$BIO
                :help-priority nil
                :help-info ""
                :help-links NIL
        ...
        (my-defclass acad-ach  (BIO scale)
               ...
               (:default-initargs
                ...
                :mean-score nil  :standard-deviation nil :sample-N nil  :relative-score nil  :reverse-scored-p NIL   :num-questions  nil
  ...
  (my-defclass sutype  (INTRO-MAQ)
               ...
               (:default-initargs
                ...
                :csartloc '$BIO
                 :relative-score nil  :reverse-scored-p NIL   :num-questions 1
                :help-priority nil
                :help-info ""
                :help-links NIL
                ))
...
#| NOT NEEDED? (my-defclass sFamily  (BIO-MAQ)
  ...
  (my-defclass sT1HigherSelf  (values-themes HQ scale)
               ...
               (:default-initargs
                ...
                :sample-N 3334   :relative-score nil  :reverse-scored-p NIL   :num-questions  10
  ...
  (my-defclass sT3FamCare (values-themes HQ scale  )
               ...
               (:default-initargs
                ...
                :mean-score ".701"  :standard-deviation ".172" :sample-N 2424
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  3
                :help-priority 0  :help-info "Changing long-established, top values is not easy. If you want to change some of these values, you can start with the help-links below."
                :help-links '("life_goals_and_meaning.htm")
                ))
  ...
  (my-defclass sT4SuccessStatusMater  (values-themes HQ scale)
               ...
               (:default-initargs
                ...
                :mean-score ".615"  :standard-deviation ".148" :sample-N 3269
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  9
                :help-priority 0  :help-info "Changing long-established, top values is not easy. If you want to change some of these values, you can start with the help-links below."
                :help-links '("life_goals_and_meaning.htm")
                ))
  (my-defclass sT5-OrderPerfectionGoodness  (values-themes HQ scale)
               ...
               (:default-initargs
                ...
                :mean-score ".649"  :standard-deviation ".142" :sample-N 3334
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  8
                :help-priority 0  :help-info "Changing long-established, top values is not easy. If you want to change some of these values, you can start with the help-links below."
                :help-links '("life_goals_and_meaning.htm")
                ))
  (my-defclass sT6GodSpiritRelig  (values-themes HQ scale)
               ...
               (:default-initargs
                ...
                :mean-score ".555"  :standard-deviation ".240" :sample-N 2473
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  4
                :help-priority 0  :help-info "Changing long-established, top values is not easy. If you want to change some of these values, you can start with the help-links below."
                :help-links '("life_goals_and_meaning.htm")
                ))
  (my-defclass sT7ImpactChallengeExplor  (values-themes HQ scale)
               ...
               (:default-initargs
                ...
                :scale-questions '(thm10oth  thmimpac  thm28cre  thmmench   thm34exp  thmuniqu thmcreat )             :mean-score ".672"  :standard-deviation ".150" :sample-N 3312
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  7
  ...
  (my-defclass sT10OvercmProbAcceptSelf  (values-themes HQ scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "values-themes"
                   :subscales NIL
                 :csartloc '$TBV.<sT10OvercmProbAcceptSelf
                :scale-questions '( thmsprot  thmphurt)
                :mean-score ".585"  :standard-deviation ".106" :sample-N 2385
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  2
                :help-priority 0 :help-info "Changing long-established, top values is not easy. If you want to change some of these values, you can start with the help-links below."
                :help-links '("life_goals_and_meaning.htm")
                ))
  ...
  (my-defclass sworldview  (beliefs HQ scale)
      ...
      low anger/aggression, .384 with relationship success, .233 with positive health outcomes. (10 items)"  
                :scale-group-name   "beliefs"
                   :subscales '(SSWVGRATPT SSWVOPTIMS SSWVENTIT)
                 :csartloc '$TBV.<sworldview
                :scale-questions '(wovprogr wovgoodf wovmylif wovnfair  tbventit wovinjur wovabund  tbvgrati  woventit wovgrate wovposth) 
                ;;added 2020 bec got error when (slot-value *sworldview-inst 'relative-score)
                :mean-score ".624"  :standard-deviation ".153" :sample-N 3162
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  10
                :help-priority 1
  ...
  (my-defclass stbslfwo  (beliefs HQ scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "beliefs"
                   :subscales '(SSSWNONCONT SSSWHAPALLGRAT SSSWACALLSELF)
                 :csartloc '$TBV.<STBSLFWO
                ...
                :mean-score ".595"  :standard-deviation ".126" :sample-N 3246
                 :relative-score nil  :reverse-scored-p NIL   :num-questions   12
                :help-priority 1
  ...
  (my-defclass siecontr  (beliefs HQ scale)
      ...
      Believing that you are in control of your own emotions, behavior, likes and dislikes, and your life increases internal control. Making your own decisions and plans and giving adequate priority to your own needs also helps. (7 items)"
                :scale-group-name   "beliefs"
                   :subscales '(SSIEAUTONY SSIENCODEP SSIENOTHER)
                 :csartloc '$TBV.<SIECONTR
                ...
                :mean-score "616"  :standard-deviation ".162" :sample-N 3246
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  7  ;;is it really 7 or 8 SSS ???
                :help-priority 1
  ...
  (my-defclass sethbel  (beliefs HQ scale) ;;new label
               ...
               (:default-initargs
                ...
                :scale-group-name   "beliefs"
                   :subscales '(SSB2ETHIC SSB2FORGIV SSB2IDGRND SSB2GRNDMNG SSB2INRGOOD SSB2NOASTR SSB2LIFAD)
                 :csartloc '$TBV.<SETHBEL
                ...
                ;;SS  FIND MEAN, SD, N (thee are temporary fill-ins)
                :mean-score .620  :standard-deviation .112 :sample-N  2366  :relative-score nil  :reverse-scored-p NIL   :num-questions  14
                :help-priority 1
  ...
  (my-defclass sgrfears  (beliefs HQ scale)
      ...
      Overcoming these underlying fears can help you be less fearful and anxious the rest of your life! This scale correlates .462 with happiness, .417 with low depression, .375 with low anxiety, .241 with low anger/aggression. (12 items)"
                :scale-group-name   "beliefs"
                   :subscales '(SSWFSOCIAL SSWFSELF SSWFPOVFAI SSWFILLDEA)
                :csartloc '$TBV.<SGRFEARS
  ...
  (my-defclass sslfconf  (skills-confidence HQ scale)
      ...
      Your life skills and self-confidence can be powerful factors in your success and happiness in many life areas--including your academic and career success. It correlated .629 with happiness, .421 with low depression, .351 with low anxiety, .186 with low anger/aggression,.367 with relationship success, .233 with positive health outcomes. (41 items)"
                :scale-group-name   "skills-confidence"
                   :subscales '(SSSCLEARN SSSCCOPOPT SSSCSMSMSD SSSCINTERP SSSCALLHELP SSSCSCIENCE SSSCARTCRE)
                :csartloc '$SKL<SSLFCONF
                :scale-questions '(slflearn slfcritt slfresea slfanaly slfsynth slfcreat slfcompu  
                                            slfbiosc slfnatsc slflibar slfsocsc slfphilr slfperfa slffinea
                                            slfbusan slfheal2 slfengin slfeduch slfiq slfdecma slftimem 
                                            slfcope  slfself4 slfselfm	
                                            slfachan slfmana6 slfheal3 slfmeetp slfliste slfself5 slfconfl
                                            slfpersu slfmana7 slfhelps slfspeak slfjobse slfadapt 
                                            slfhappy slfoptim  slffrien slfindep)
                :mean-score ".682"  :standard-deviation ".143" :sample-N 3225
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  41
  ...
  (my-defclass sselfman  (skills-confidence HQ scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "skills-confidence"
                   :subscales '(SSSMTIMEMANGOALSET SSSMACCOMPLORUSH SSSMSELFDEVEL SSSMHEALTHHABS)
                :csartloc '$SKL.<SSELFMAN
                ...
                :mean-score ".537"  :standard-deviation ".160" :sample-N 1936
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  15
                :help-priority 1
  ...
  (my-defclass semotcop  (skills-confidence HQ scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "skills-confidence"
                   :subscales '(SSCPPROBSOLV SSCPPOSTHOUGHTS SSCPPOSACTS SSCPNOBLAMEANGERWDRAW SSCPNOTSMOKDRUGMED SSCPNOTEAT)
                :csartloc '$SKL.<SEMOTCOP
                ...
                :mean-score ".585"  :standard-deviation ".135" :sample-N 3273
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  20
                :help-priority 1
  ...
  (my-defclass IntSS1aAssertCR  (interpersonal HQ scale)
               ...
               (:default-initargs
                ...
                :mean-score ".563"  :standard-deviation ".186" :sample-N 2664
                 :relative-score nil  :reverse-scored-p NIL   :num-questions  14
                :help-priority 1
  ...
  #|(my-defclass IntSS8Separate  (interpersonal HQ scale)
   ...
   ;;-.023ns .061 .127 .102 -.018ns -.061
         ...
         :description "Spending weekends alone OK.  Not consult for small decisions. This scale correlated .215 with overall relationship success. ,.379 with overall happiness, .288 with low depression, .308 with low anxiety,.389 with low anger/aggression, and .296 with the health scale. This scale had only small positive corelations with low depression and low anxiety. (2 items)"
             ...
             :mean-score nil  :standard-deviation nil :sample-N nil   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
  ...
  (my-defclass scollege  (ACAD-LEARNING scale)
               ...
               (:default-initargs
                ...
                :mean-score .6  :standard-deviation .15 :sample-N 1000   :relative-score nil  :reverse-scored-p NIL   :num-questions  6
                :help-priority 1 :help-info ""
                :help-links NIL
                ))
  ...
  (my-defclass ssl1ConfidEfficStudyTest  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl1ConfidEfficStudyTest
                ...
                :mean-score .59  :standard-deviation .21 :sample-N  637   :relative-score nil  :reverse-scored-p NIL   :num-questions   13 
                :help-priority 1
  ...
  (my-defclass ssl1bConfidNotAvoidStudy  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl1bConfidNotAvoidStudy
                :scale-questions '(lrnunasn  lrncolmt  lrntired  lrnaread  lrnproof  )
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .643  :standard-deviation .199 :sample-N 953   :relative-score nil  :reverse-scored-p NIL   :num-questions  5
                :help-priority 1
  ...
  (my-defclass ssl2SatisCampusFacFriendsGrdes   (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl2SatisCampusFacFriendsGrdes
                :scale-questions '(stulookf  stulikei  stucomfo  stufrien   stuenjoy  stueactr  sthapcol  sthapgpa)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .682  :standard-deviation .200 :sample-N 1000   :relative-score nil  :reverse-scored-p NIL   :num-questions   8
  ...
  (my-defclass ssl3WriteReadSkills  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl3WriteReadSkills
                :scale-questions '(lrnwrpap  lrnwrskl  lrnsee  lrnvocab  lrnwrorg lrnsread)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .728  :standard-deviation .199 :sample-N 953   :relative-score nil  :reverse-scored-p NIL   :num-questions  6
                :help-priority 1
  ...
  (my-defclass ssl4BldMentalStruct  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl4BldMentalStruct
                :scale-questions '( lrntxund  lrninter lrnrote  lrnassoc  lrnstrug  lrntheor  lrnalone)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .693  :standard-deviation .174 :sample-N 1112   :relative-score nil  :reverse-scored-p NIL   :num-questions  7 
                :help-priority 1
  ...
  (my-defclass ssl5BasicStudySkills  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl5BasicStudySkills
                :scale-questions '(acmconce  lrntxove  lrntsrev  lrnmap  lrntxout  lrnnotes)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .610  :standard-deviation .196 :sample-N 814   :relative-score nil  :reverse-scored-p NIL   :num-questions  6
                :help-priority 1
                :help-info "The essence of higher level learning is developing complex cognitive, mental structures.  Learning techniques for doing developing these mental structures is a primary way to increase intelligence, learning efficiency, and academic success."
                :help-links '("LEARN.htm" "academic.htm" )
                ))
  (my-defclass ssl6SelfmanAcadGoals  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl6SelfmanAcadGoals
                :scale-questions '(acmcompl  acmquitc  acmfinan  acmdegre  stuconfu acmselfs)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .745  :standard-deviation .206 :sample-N 819  :relative-score nil  :reverse-scored-p NIL   :num-questions  5
                :help-priority 1
  ...
  (my-defclass ssl7MathSciPrinc  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl7MathSciPrinc
                :scale-questions '(lrnmath  lrntextn)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .647  :standard-deviation .246 :sample-N 948   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
                :help-priority 1
  ...
  (my-defclass ssl8StudyEnvir  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl8StudyEnvir
                :scale-questions '(acmefaml  acmesocs  lrnestud)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .632  :standard-deviation .166 :sample-N 814   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
                :help-priority 1
  ...
  (my-defclass ssl9AttendHW  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl9AttendHW
                :scale-questions '(acmstudy acmndrop  acmatten  )
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .658  :standard-deviation .232 :sample-N  819   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
                :help-priority 1
  ...
  (my-defclass ssl10MemNotAnx  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl10MemNotAnx
                :scale-questions '( lrnmemor  lrntense  lrnsefic)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .593  :standard-deviation .222 :sample-N 953   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
                :help-priority 1
  ...
  (my-defclass ssl11NotNonAcadMot  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl11NotNonAcadMot
                :scale-questions '(stuextmo  stumoneynew  stuconfu  stufinde stucaree)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .593  :standard-deviation .222 :sample-N 953   :relative-score nil  :reverse-scored-p NIL   :num-questions  5
                :help-priority 1
  ...
  (my-defclass ssl12StdyTmAvail  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl12StdyTmAvail
                :scale-questions '(acmtime)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .520  :standard-deviation .257 :sample-N 819  :relative-score nil  :reverse-scored-p NIL   :num-questions  1
                :help-priority 1
                :help-info 
  ...
  (my-defclass ssl13VerbalApt  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl13VerbalApt
                :scale-questions '(stuverba)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .774  :standard-deviation .217 :sample-N 1003   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
  ...
  (my-defclass ssl14MathApt  (acad-learning scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "acad-learning"
                   :subscales NIL
                :csartloc '$LRN.<ssl14MathApt
                :scale-questions '(stumatha)
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score .729  :standard-deviation .233 :sample-N 1003   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
                :help-priority 0 :help-info "Aptitude has both genetic and learning componenets.  You can increase your verbal aptitude through taking appropriate classes, studying, and improving learning methods."
  ...
  (my-defclass sincar  (career-interest scale)
     ...
     NOTE: This test is meant only to suggest some possible academic majors you may show interest in, it is NOT MEANT TO BE AN ALL INCLUSIVE LIST. You should explore the complete catalog of majors at your univesity or college--especially if you have specialized interests or interests not represented in this scale. You might also consider a dual major or special major tailored to your interests."
                ...
                ;;SSS FILLED IN TEMP SCORES BEC NO DATA YET
                :mean-score NIL  :standard-deviation NIL :sample-N NIL   :relative-score nil  :reverse-scored-p NIL   :num-questions  29
  ...
  (my-defclass sinbus  (career-interest scale)
               ...
               (:default-initargs
                ...
                ;;SSS NO DATA YET
                :mean-score nil  :standard-deviation nil :sample-N nil   :relative-score nil  :reverse-scored-p NIL   :num-questions  7
  ...
  (my-defclass sinengr  (career-interest scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "career-interest"
                   :subscales NIL
                :csartloc '$CARI.<sinengr
                :scale-questions '(carieeng carime cariche2 caricive cariaero carieite caricom9 caribcom )
                ;;SSS NO DATA YET
                :mean-score nil  :standard-deviation nil :sample-N nil    :relative-score nil  :reverse-scored-p NIL   :num-questions  8
                :help-priority nil :help-info "Go to help-link below and/or see help information for College Major Interest Test: Overall Interests Scale"
                :help-links '("c15-carp.htm")
                ))
  ...
  (my-defclass sinhelp  (career-interest scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "career-interest"
                   :subscales NIL
                :csartloc '$CARI.<sinhelp
                :scale-questions '(cariteac caricoun carieduc carihadu carihchi caritvoc caricom4 carsocwo cark12te  carminis)
                ;;SSS NO DATA YET
                :mean-score nil  :standard-deviation nil :sample-N nil    :relative-score nil  :reverse-scored-p NIL   :num-questions  10
                :help-priority nil :help-info "Go to help-link below and/or see help information for College Major Interest Test: Overall Interests Scale"
                :help-links '("c15-carp.htm")
                ))
  (my-defclass sinlang  (career-interest scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "career-interest"
                   :subscales NIL
                :csartloc '$CARI.<sinlang
                :scale-questions '(carifren cariital carigerm cariruss carijapn carichin  cariclas carispan caripor)
                ;;SSS NO DATA YET
                :mean-score nil  :standard-deviation nil :sample-N nil    :relative-score nil  :reverse-scored-p NIL   :num-questions  9
                :help-priority nil :help-info "Go to help-link below and/or see help information for College Major Interest Test: Overall Interests Scale"
                :help-links '("c15-carp.htm")
                ))
  ...
  (my-defclass sinmiltc  (career-interest scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "career-interest"
                   :subscales NIL
                :csartloc '$CARI.<sinmiltc
                :scale-questions '(carilaw caricrim carimil7)
                :mean-score nil  :standard-deviation nil :sample-N nil   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
                :help-priority nil :help-info "Go to help-link below and/or see help information for College Major Interest Test: Overall Interests Scale"
                :help-links '("c15-carp.htm")
                ))
  (my-defclass inNatSci  (career-interest scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "career-interest"
                   :subscales NIL
                :csartloc '$CARI.<inNatSci
                :scale-questions '(cariche3 cariphys carigeol cariastr carienvi)
                :mean-score nil  :standard-deviation nil :sample-N nil   :relative-score nil  :reverse-scored-p NIL   :num-questions  5
                :help-priority nil :help-info "Go to help-link below and/or see help information for College Major Interest Test: Overall Interests Scale"
                :help-links '("c15-carp.htm")
                ))
  (my-defclass sinsocsc  (career-interest scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "career-interest"
                   :subscales NIL
                :csartloc '$CARI.<sinsocsc
                :scale-questions '(caripsyc carisoco carihist caripols cariecon cargeogr cariamer cariantr carianth  carispee carling  )
                :mean-score nil  :standard-deviation nil :sample-N nil   :relative-score nil  :reverse-scored-p NIL   :num-questions  11
                :help-priority nil :help-info "Go to help-link below and/or see help information for College Major Interest Test: Overall Interests Scale"
                :help-links '("c15-carp.htm")
                ))
  (my-defclass sinwoeth  (career-interest scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "career-interest"
                   :subscales NIL
                :csartloc '$CARI.<sinwoeth
                :scale-questions '(cariaist caribstu carimexa cariasam cariamst cariwstu)
                :mean-score nil  :standard-deviation nil :sample-N nil   :relative-score nil  :reverse-scored-p NIL   :num-questions  6
                :help-priority nil :help-info "Go to help-link below and/or see help information for College Major Interest Test: Overall Interests Scale"
                :help-links '("c15-carp.htm")
                ))
  ...
  (my-defclass sehappy  (outcome scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "outcome"
                   :subscales '(HAPSDMEANSPIRITSS HAPCAREEREXSS HAPRECPESS HAPAREASS HAPFAMSS HAPROMSS HAPFRIENDSSS HAPFUTURESS HAPPASTSS HAPRECENTSS)
                :csartloc '$OUTC.<sehappy
                ...
                :mean-score ".600"  :standard-deviation ".184" :sample-N  3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  15
  ...
  (my-defclass srdepres  (outcome scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "outcome"
                   :subscales '(SSDELODEPSYMP SSDELODEPTREATS)
                :csartloc '$OUTC.<srdepres
  ...
  (my-defclass sranxiet  (outcome scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "outcome"
                   :subscales '(SSAXLOPERFGENANX SSAXLOWFEAROCD SSAXLOANXTREATS)
                :csartloc '$OUTC.<sranxiet
                :scale-questions '(ranxperf ranxallt ranxpstd ranxsoci ranxocd ranxphob ranxpani ranxther  ranxmeds) 
                :mean-score ".719"  :standard-deviation ".183"
                  :sample-N 3298   :relative-score nil 
                  :reverse-scored-p NIL   :num-questions  9
  ...
  (my-defclass srangagg  (outcome scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "outcome"
                   :subscales NIL
                :csartloc '$OUTC.<srangagg
                :scale-questions '(rangfeel rangyell rangdomi rangthou rangdest)
                :mean-score ".772"  :standard-deviation ".163" :sample-N 3262   :relative-score nil  :reverse-scored-p NIL   :num-questions  5
  ...
  (my-defclass srelhlth  (outcome scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "outcome"
                   :subscales '(SSHELONEGADDICTHABS SSHELOFREQILL SSHEPELOWEIGHT)
                :csartloc '$OUTC.<srelhlth
                :scale-questions '(rhlfreqi rhlalcoh rhlsmoke rhldrugs rhlphysi rhlweigh)
                :mean-score ".702"  :standard-deviation ".133" :sample-N 3081   :relative-score nil  :reverse-scored-p NIL   :num-questions  6
  ...
  (my-defclass srpeople  (outcome scale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "outcome"
                   :subscales '(SSRECLOSEFRIENDS SSREROMRELSUC SSRENUMFRIENDS SSREHAPSUCFRS)
                :csartloc '$OUTC.<srpeople
                :scale-questions '(rpehapfr rpehmarr rpenetw rpeclfrn rpenumfr rpenumcl rpecommi)
                :mean-score ".521"  :standard-deviation ".153" :sample-N 2673   :relative-score nil  :reverse-scored-p NIL   :num-questions  7
  ...
  (my-defclass sswvgratpt  (sworldview subscale)
               ...
               (:default-initargs
                ...
                :mean-score ".668"  :standard-deviation ".198"  :sample-N 3200   :relative-score nil  :reverse-scored-p NIL   :num-questions  5
  ...
  (my-defclass sswvoptims  (sworldview subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sworldview"
                 :subscales NIL
                :csartloc '$TBV.<SWORLDVIEW.<sswvoptims
                :scale-questions '(wovprogr  wovgoodf  wovmylif wovposth)
                :mean-score "641"  :standard-deviation ".196" :sample-N 3200   :relative-score nil  :reverse-scored-p NIL   :num-questions  4
  ...
  (my-defclass sswventit  (sworldview subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sworldview"
                   :subscales NIL
                :csartloc '$TBV.<SWORLDVIEW.<sswventit
                :scale-questions '(tbventit wovnfair  wovinjur  woventit)
                :mean-score ".496"  :standard-deviation ".208" :sample-N 3162   :relative-score nil  :reverse-scored-p NIL   :num-questions  0
  ...
  (my-defclass ssswNonCont  (stbslfwo subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "stbslfwo"
                   :subscales NIL
                :csartloc '$TBV.<stbslfwo.<ssswNonCont
                :scale-questions '(tbvothfi  tbvliked  tbvweak  tbvbest  tbvrules  tbvwinne)
                :mean-score ".655"  :standard-deviation "165" :sample-N 3246   :relative-score nil  :reverse-scored-p NIL   :num-questions  6  ;;SSS tbvweak HERE OR bacallsf--accept all self--not weak or dependent'
  ...
  (my-defclass ssswHapAllGrat  (stbslfwo subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "stbslfwo"
                   :subscales NIL
                :csartloc '$TBV.<stbslfwo.<ssswHapAllGrat
                :scale-questions '(tbvbalan tbvhapca tbvgrati thvuncon thvselfw)
                :mean-score ".573"  :standard-deviation ".172" :sample-N 3246   :relative-score nil  :reverse-scored-p NIL   :num-questions  5
  ...
  (my-defclass ssswAcAllSelf  (stbslfwo subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "stbslfwo"
                   :subscales NIL
                :csartloc '$TBV.<stbslfwo.<ssswAcAllSelf
                :scale-questions '( thvselfa) ;;SSS CHECK THIS did include tbvweak
                :mean-score ".343"  :standard-deviation ".216" :sample-N 3246   :relative-score nil  :reverse-scored-p NIL   :num-questions  1 ;;was 2
  ...
  (my-defclass ssieautony  (siecontr subscale)
               ...
               (:default-initargs
                ...
                :mean-score ".702"  :standard-deviation ".211" :sample-N 2690   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
  ...
  (my-defclass ssiencodep  (siecontr subscale)
               ...
               (:default-initargs
                ...
                :mean-score ".538"  :standard-deviation ".238" :sample-N 2690   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
  ...
  (my-defclass ssienother  (siecontr subscale)
               ...
               (:default-initargs
                ...
                :mean-score ".565"  :standard-deviation ".214" :sample-N 2690   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
  ...
  (my-defclass ssb2Ethic  (sethbel subscale)
               ...
               (:default-initargs
                ...
                :mean-score ".672"  :standard-deviation ".150" :sample-N 2366   :relative-score nil  :reverse-scored-p NIL   :num-questions  4
  ...
  (my-defclass ssb2Forgiv  (sethbel subscale)
               ...
               (:default-initargs
                ...
                :mean-score ".751"  :standard-deviation ".192" :sample-N 2366   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
  ...
  (my-defclass ssb2IDgrnd  (sethbel subscale)
               ...
               (:default-initargs
                ...
                :mean-score ".412"  :standard-deviation ".165" :sample-N 2366   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
  ...
  (my-defclass ssb2GrndMng  (sethbel subscale)
               ...
               (:default-initargs
                ...
                :mean-score ".624"  :standard-deviation ".204" :sample-N 2366   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
  ...
  (my-defclass ssb2InrGood  (sethbel subscale)
               ...
               (:default-initargs
                ...
                :mean-score ".546"  :standard-deviation ".182" :sample-N 2366   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
  ...
  (my-defclass ssb2noAstr  (sethbel subscale)
               ...
               (:default-initargs
                ...
                :mean-score ".718"  :standard-deviation ".242" :sample-N 2366   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
  ...
  #|(my-defclass sstb3Forgive  (sethbel subscale)
             ...
             (:default-initargs
              ...
              :scale-group-name   "sethbel"
                   :subscales NIL
             :scale-questions '()
             :mean-score nil  :standard-deviation nil :sample-N nil   :relative-score nil  :reverse-scored-p NIL   :num-questions  0
              :help-info ""
              :help-links '()
              ))|#
  ...
  (my-defclass sswfsocial  (sgrfears subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sgrfears"
                   :subscales NIL
                :csartloc '$TBV.<sgrfears.<sswfsocial
  ...
  (my-defclass sswfself  (sgrfears subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sgrfears"
                   :subscales NIL
                :csartloc '$TBV.<sgrfears.<sswfself
  ...
  (my-defclass sswfpovfai  (sgrfears subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sgrfears"
                   :subscales NIL
                :csartloc '$TBV.<sgrfears.<sswfpovfai
  ...
  (my-defclass sswfilldea  (sgrfears subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sgrfears"
                   :subscales NIL
                :csartloc '$TBV.<sgrfears.<sswfilldea
  ...
  (my-defclass sssclearn  (sslfconf subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sslfconf"
                   :subscales NIL
                :csartloc '$SKL.<sslfconf.<sssclearn
                :scale-questions '(slflearn  slfcritt  slfresea  slfanaly  slfsynth    slfcompu  slfiq )
                :mean-score ".801"  :standard-deviation ".143" :sample-N 3225   :relative-score nil  :reverse-scored-p NIL   :num-questions  7
  ...
  (my-defclass sssccopopt  (sslfconf subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sslfconf"
                   :subscales NIL
                :csartloc '$SKL.<sslfconf.<sssccopopt
                :scale-questions '(slfself4  slfcope  slfself5  slfconfl   slfoptim  slffrien)
                :mean-score ".623"  :standard-deviation ".201" :sample-N 3225   :relative-score nil  :reverse-scored-p NIL   :num-questions  6
  ...
  (my-defclass ssscsmsmsd  (sslfconf subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sslfconf"
                   :subscales NIL
                :csartloc '$SKL.<sslfconf.<ssscsmsmsd
  ...
  (my-defclass ssscinterp  (sslfconf subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sslfconf"
                   :subscales NIL
                :csartloc '$SKL.<sslfconf.<ssscinterp
  ...
  (my-defclass ssscallhelp  (sslfconf subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sslfconf"
                   :subscales NIL
                :csartloc '$SKL.<sslfconf.<ssscallhelp
  ...
  (my-defclass ssscscience  (sslfconf subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sslfconf"
                   :subscales NIL
                :csartloc '$SKL.<sslfconf.<ssscscience
                :scale-questions '(slfbiosc  slfnatsc  slfheal2  slfengin)
                :mean-score ".583"  :standard-deviation ".201"
                :sample-N 3225   :relative-score nil  :reverse-scored-p NIL   :num-questions  4
  ...
  (my-defclass ssscartcre  (sslfconf subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sslfconf"
                   :subscales NIL
                :csartloc '$SKL.<sslfconf.<ssscartcre
                :scale-questions '(slfcreat  slfperfa  slffinea)
                :mean-score ".659"  :standard-deviation ".204"
                :sample-N 3225   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
  ...
  (my-defclass sssmTimeManGoalSet (sselfman  subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sselfman"
                   :subscales NIL
                :csartloc '$SKL.<sselfman.<sssmTimeManGoalSet
                :scale-questions '(smtfutur  smtptodo smtgoals  smtschd   smt2dtod)
                :mean-score ".505"  :standard-deviation ".220"
                :sample-N 2127   :relative-score nil  :reverse-scored-p NIL   :num-questions  5
  ...
  (my-defclass sssmAccompLoRush (sselfman  subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sselfman"
                   :subscales NIL
                :csartloc '$SKL.<sselfman.<sssmAccompLoRush
                :scale-questions '(smtbusy  smtacmpl)
                :mean-score ".494"  :standard-deviation ".222" 
                :sample-N 2127   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
  ...
  (my-defclass sssmSelfDevel (sselfman  subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sselfman"
                   :subscales NIL
                :csartloc '$SKL.<sselfman.<sssmSelfDevel
                :scale-questions '(smtsdeve  smtghelp  smthabch)
                :mean-score ".647"  :standard-deviation ".214"
                :sample-N 1936   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
  ...
  (my-defclass sssmHealthHabs (sselfman  subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sselfman"
                   :subscales NIL
                :csartloc '$SKL.<sselfman.<sssmHealthHabs
                :scale-questions '(smtexerc  smteath  smtsleep)
                :mean-score ".558"  :standard-deviation ".176"
                :sample-N 2127   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
  ...
  (my-defclass sscpProbSolv  (semotcop subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "semotcop"
                   :subscales NIL
                :csartloc '$SKL.<semotcop.<sscpProbSolv
                :scale-questions '(coppsolv  coptalks  copexpec  copselfe)
                :mean-score ".599"  :standard-deviation ".182"
                :sample-N 3273   :relative-score nil  :reverse-scored-p NIL   :num-questions  4
  ...
  (my-defclass sscpPosThoughts  (semotcop subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "semotcop"
                   :subscales NIL
                :csartloc '$SKL.<semotcop.<sscpPosThoughts
                :scale-questions '(copnegth  coppepta)
                :mean-score ".477"  :standard-deviation ".204"
                :sample-N 3273   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
  ...
  (my-defclass sscpPosActs  (semotcop subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "semotcop"
                   :subscales NIL
                :csartloc '$SKL.<semotcop.<sscpPosActs
  ...
  (my-defclass sscpNoBlameAngerWDraw  (semotcop subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "semotcop"
                   :subscales NIL
                :csartloc '$SKL.<semotcop.<sscpNoBlameAngerWDraw
                :scale-questions '(copemota  copblame  copwdrw  copnegph   copselfb)
                :mean-score ".580"  :standard-deviation ".202"
                :sample-N 3273   :relative-score nil  :reverse-scored-p NIL   :num-questions  5
  ...
  (my-defclass sscpNotSmokDrugMed  (semotcop subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "semotcop"
                   :subscales NIL
                :csartloc '$SKL.<semotcop.<sscpNotSmokDrugMed
  ...
  (my-defclass sscpNotEat  (semotcop subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "semotcop"
                   :subscales NIL
                :csartloc '$SKL.<semotcop.<sscpNotEat
                :scale-questions '(copcopea)
                :mean-score ".665"  :standard-deviation ".284"
                :sample-N 3273   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
  ...
  (my-defclass hapSDMeanSpiritSS  (sehappy subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sehappy"
                   :subscales NIL
                :csartloc '$OUTC.<sehappy.<hapSDMeanSpiritSS
                :scale-questions '(hapselfd  hapspiri)
                :mean-score .6132 :standard-deviation .250 :sample-N 3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
                :help-priority 1
  ...
  (my-defclass hapCareerExSS  (sehappy subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sehappy"
                   :subscales NIL
                :csartloc '$OUTC.<sehappy.<hapCareerExSS
                :scale-questions '(hapcarfu hapcarnw )
                :mean-score .610  :standard-deviation .250 :sample-N 3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
                ;;SSS CHANGE
                :help-priority 1
  ...
  (my-defclass hapRecPESS (sehappy subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sehappy"
                   :subscales NIL
                :csartloc '$OUTC.<sehappy.<hapRecPESS
                :scale-questions '(happe haprecre)
                :mean-score .559  :standard-deviation .248 :sample-N 3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
                :help-priority 1
  ...
  (my-defclass hapAreaSS  (sehappy subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sehappy"
                   :subscales NIL
                :csartloc '$OUTC.<sehappy.<hapAreaSS
                :scale-questions '(haparea)
                ;;SSS NO DATA YET
                :mean-score .6  :standard-deviation .25 :sample-N 3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
                :help-priority 1
                :help-info "Happiness is the result of other factors. Examine your results on the HQ scales for ways you can improve your happiness."
                :help-links '("index.html" "self-helpLinks.htm" "c15-carp.htm")
                ))
  (my-defclass hapFamSS  (sehappy subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sehappy"
                   :subscales NIL
                :csartloc '$OUTC.<sehappy.<hapFamSS
                :scale-questions '(hapfamil)
                :mean-score .640  :standard-deviation .272 :sample-N 3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
                :help-priority 1
                :help-info "Happiness is the result of other factors. Examine your results on the HQ scales for ways you can improve your happiness."
                :help-links '("index.html" "self-helpLinks.htm" "c15-carp.htm")
                ))
  (my-defclass hapRomSS  (sehappy subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sehappy"
                   :subscales NIL
                :csartloc '$OUTC.<sehappy.<hapRomSS
                :scale-questions '(hapsexre)
                :mean-score .461 :standard-deviation .303 :sample-N 3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
                :help-priority 1
  ...
  (my-defclass hapFriendsSS  (sehappy subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sehappy"
                   :subscales NIL
                :csartloc '$OUTC.<sehappy.<hapFriendsSS
                :scale-questions '(hapclfrn hapfrien hapwkrel)
                :mean-score .621  :standard-deviation .250 :sample-N 3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
                :help-priority 1
                :help-info "Happiness is the result of other factors. Examine your results on the HQ scales for ways you can improve your happiness-especially the ones related to interpersonal relationships."
  ...
  (my-defclass hapFutureSS  (sehappy subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sehappy"
                   :subscales NIL
                :csartloc '$OUTC.<sehappy.<hapFutureSS
                :scale-questions '(hapexpec)
                :mean-score .757  :standard-deviation .235 :sample-N 3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
  ...
  (my-defclass hapPastSS  (sehappy subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sehappy"
                   :subscales NIL
                :csartloc '$OUTC.<sehappy.<hapPastSS
                :scale-questions '(haplife)
                :mean-score .609  :standard-deviation .261 :sample-N 3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
                :help-priority 1  :help-info "Happiness is the result of other factors. Examine your results on the HQ scales for ways you can improve your happiness."
                :help-links '("index.html" "self-helpLinks.htm")
                ))
  (my-defclass hapRecentSS  (sehappy subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sehappy"
                   :subscales NIL
                :csartloc '$OUTC.<sehappy.<hapRecentSS
                :scale-questions '(hapyear  hap3year)
                :mean-score .558  :standard-deviation .246 :sample-N 3185   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
  ...
  (my-defclass ssreCloseFriends  (srpeople subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "srpeople"
                   :subscales NIL
                :csartloc '$PEOP.<srpeople.<ssreCloseFriends
                :scale-questions '(rpenetw rpeclfrn)
                :mean-score .215  :standard-deviation .136 :sample-N 2673   :relative-score nil  :reverse-scored-p NIL   :num-questions  0
  ...
  (my-defclass ssreRomRelSuc  (srpeople subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "srpeople"
                   :subscales NIL
                :csartloc '$PEOP.<srpeople.<ssreRomRelSuc
                :scale-questions '(rpehmarr rpecommi )
                :mean-score .630  :standard-deviation .311 :sample-N 2673   :relative-score nil  :reverse-scored-p NIL   :num-questions  0
  ...
  (my-defclass ssreNumFriends  (srpeople subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "srpeople"
                   :subscales NIL
                :csartloc '$PEOP.<srpeople.<ssreNumFriends
                :scale-questions '(rpenumfr rpenumcl)
                :mean-score .305  :standard-deviation .204 :sample-N 2673   :relative-score nil  :reverse-scored-p NIL   :num-questions  0
  ...
  (my-defclass ssreHapSucFrs  (srpeople subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "srpeople"
                   :subscales NIL
                :csartloc '$PEOP.<srpeople.<ssreHapSucFrs
                :scale-questions '(rpehmarr rpecommi )
                :mean-score .623  :standard-deviation .232 :sample-N 2673   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
                :help-priority 1
  ...
  (my-defclass ssdeLoDepSymp  (srdepres subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "srdepres"
                   :subscales NIL
                               :csartloc '$OUTC.<srdepres.<ssdeLoDepSymp
                :scale-questions '(rdepfeel rdepthou rdepdyss rdepmajs)
                :mean-score .515  :standard-deviation .255 :sample-N 2819   :relative-score nil  :reverse-scored-p NIL   :num-questions  4
  ...
  (my-defclass ssdeLoDepTreats  (srdepres subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "srdepres"
                   :subscales NIL
                  :csartloc '$OUTC.<srdepres.<ssdeLoDepTreats
                :scale-questions '(rdepmeds rdepther) 
                :mean-score .767  :standard-deviation .286 :sample-N 2819   :relative-score nil  :reverse-scored-p NIL   :num-questions  2
                :help-priority 1     :help-info "See Depression main scale help information and help-links."
                :help-links '("depression.htm" "my-peek.htm" "h85cdepr.htm")
                ))
 ...
 |#
  ...
  (my-defclass ssaxLoPerfGenAnx  (sranxiet subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sranxiet"
                   :subscales NIL
                  :csartloc '$OUTC.<sranxiet.<ssaxLoPerfGenAnx
                :scale-questions '(ranxperf ranxallt ranxpstd ranxsoci)
                :mean-score .573  :standard-deviation .237 :sample-N 3298   :relative-score nil  :reverse-scored-p NIL   :num-questions  4
  ...
  (my-defclass ssaxLowFearOCD  (sranxiet subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sranxiet"
                   :subscales NIL
                  :csartloc '$OUTC.<sranxiet.<ssaxLowFearOCD
                :scale-questions '(ranxocd ranxphob ranxpani)
                :mean-score .774  :standard-deviation .211 :sample-N 3298   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
  ...
  (my-defclass ssaxLoAnxTreats  (sranxiet subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "sranxiet"
                   :subscales NIL
                  :csartloc '$OUTC.<sranxiet.<ssaxLoAnxTreats
                :scale-questions '( ranxther  ranxmeds) 
                :mean-score .832  :standard-deviation .259 :sample-N 3325   :relative-score nil  :reverse-scored-p NIL   :num-questions  0
                :help-priority 1     :help-info "See Anxiety main scale help information and help-links."
                :help-links '("anxiety.htm"  "my-peek.htm" "h8hf2.htm")
                ))
  ...
  (my-defclass ssheLoNegAddictHabs (srelhlth subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "srelhlth"
                   :subscales NIL
                  :csartloc '$OUTC.<$HLTH.<ssheLoNegAddictHabs
                :scale-questions '( rhlalcoh rhlsmoke rhldrugs)
                :mean-score .776  :standard-deviation .181 :sample-N 3081   :relative-score nil  :reverse-scored-p NIL   :num-questions  3
  ...
  (my-defclass ssheLoFreqIll (srelhlth subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "srelhlth"
                   :subscales NIL
                  :csartloc '$OUTC.<$HLTH.<ssheLoFreqIll
                :scale-questions '(rhlfreqi)
                :mean-score .659  :standard-deviation .245 :sample-N 3173   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
  ...
  (my-defclass sshePELoWeight (srelhlth subscale)
               ...
               (:default-initargs
                ...
                :scale-group-name   "srelhlth"
                   :subscales NIL
                  :csartloc '$OUTC.<$HLTH.<sshePELoWeight
                :scale-questions '( rhlphysi rhlweigh)
                :mean-score .683  :standard-deviation .272 :sample-N 3173   :relative-score nil  :reverse-scored-p NIL   :num-questions  0
...
((STUCOLLE STUMAJOR STUSPECI STURESID STU-DATA STGPATRE STUAPT STUFEEL STURESOURCE STUACMOTIV STU-LRN) ("Academic-Related Scales:"))|#
  ...
  (my-defclass sUserFeedback (scale) 
               ...
               (:default-initargs
                ...
                :mean-score nil  :standard-deviation nil :sample-N nil   :relative-score nil  :reverse-scored-p NIL   :num-questions  1
                ))
